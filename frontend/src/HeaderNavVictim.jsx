...
const HeaderNavVictim = () => {
  const location = useLocation();
  const [current, setCurrent] = useState(location.pathname);

  const menuItems = [
    { key: '/', label: 'Home', link: '/' },
    { key: '/incident-report', label: 'Report Incident', link: '/incident-report' },
    { key: '/track-request', label: 'Track Incident', link: '/track-request' },
...
export default HeaderNavVictim;
